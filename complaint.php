            ...
            <div class="container">
                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="row gy-4">
                            <div class="col-md-4">
                                ...
                                <p><i class="fa fa-envelope-open text-primary me-2"></i>payingguest@gmail.com</p>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <p><i class="fa fa-envelope-open text-primary me-2"></i>tech@gamil.com</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 wow fadeIn" data-wow-delay="0.1s">
                        <iframe class="position-relative rounded w-100 h-100"
                            src="//www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d972.451378998854!2d74.83912276719664!3d12.855834595386126!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba35bb02ab6ad6f%3A0xec5736fb4a8ac91f!2sVR4Q%2BHJQ%2C%20Pandeshwar%2C%20Mangaluru%2C%20Karnataka%20575001!5e0!3m2!1sen!2sin!4v1682912685761!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>"
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <form id="complaintForm">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                    <input type="submit" class="mainBtn" id="submit" name="send" value="Send Message">
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="col-md-5 col-sm-6">
                        <h3 class="widget-title">Send Query</h3>
                        <div class="contact-form">
                            <form name="contactform" id="contactform" action="#" method="post">
                                ...
                                <p>
                                <div class="row g-3">
                                    <input name="subject" type="text" id="subject" placeholder="Subject" name="subject" required="" > 
                                </div>
                                </p>
                                <p>
                                <div class="row g-3">
...
if (isset($_POST['send'])) 
{
        ...
        $query=mysqli_query($conn,"INSERT INTO `complaint`(`name`, `email`, `subject`, `msg`) VALUES ('$name','$email','$subject','$msg')") or die(mysqli_error($conn));
            if ($query==true) 
            {
