...
//    $total_product = implode(', ',$hidden_name);
   $detail_query = mysqli_query($conn, "INSERT INTO `payments`(room_id,name, email, check_in_date , check_out_date , rent , request) VALUES('$room_id','$name','$check_in_date','$check_out_date','$rent','$request')") or die('query failed');
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="room_id" placeholder="room_id">
                                    ...
                                    <div class="col-12">
                                        <button class="btn btn-primary w-100 py-3" type="submit" value="payments" name="payments">Book Now</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
if (isset($_POST['submit'])) 
{
        ...
        $query=mysqli_query($conn,"INSERT INTO `payments`(room_id,name, email, check_in_date , check_out_date , rent , request) VALUES('$room_id','$name','$check_in_date','$check_out_date','$rent','$request')") or die(mysqli_error($conn));
            if ($query==true) 
            {
